...
namespace Hospital_management_System.Users
{
    ...
    {
        static string connectionString = @"Data Source=.;Initial Catalog=pulkit;User ID=sa;Password=shield1267";
...
/*            int id1 = 0;
        ...
        protected void btn_login_b_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string str = "insert into Users (ID, Username, Email, Mobile, Pass) values('" + txt_signup_username.Text + "','" + txt_signup_email.Text + "','" + txt_signup_mobile.Text + "','" + txt_signup_pass.Text + "')";
